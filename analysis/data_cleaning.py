...
def clean_join_df(df_eval, df_contributeurs_eval): #its called df_eval here but it can be explo or eval
    ...
    divisor = df_eval.loc[df_eval['Lot'] == 'Lot 10 Réseaux énergie - courant fort', 'Quantité'].values[0]
